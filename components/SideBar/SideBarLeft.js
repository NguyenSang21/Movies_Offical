            ...
            <div id="primary-menu-offcanvas" class="off-canvas off-canvas-left d-flex flex-column">
                <div class="m-3">
                    <a class="close-offcanvas-main-menu" href="#" data-target="#primary-menu-offcanvas">
                        <span class="adonis-icon icon-5x"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 24 24"><path d="M13.4 12l5.3-5.3c0.4-0.4 0.4-1 0-1.4s-1-0.4-1.4 0l-5.3 5.3-5.3-5.3c-0.4-0.4-1-0.4-1.4 0s-0.4 1 0 1.4l5.3 5.3-5.3 5.3c-0.4 0.4-0.4 1 0 1.4 0.2 0.2 0.4 0.3 0.7 0.3s0.5-0.1 0.7-0.3l5.3-5.3 5.3 5.3c0.2 0.2 0.5 0.3 0.7 0.3s0.5-0.1 0.7-0.3c0.4-0.4 0.4-1 0-1.4l-5.3-5.3z"></path></svg></span>
                    </a>
                </div>
                <div class="side-nav-container d-flex flex-column align-items-center ml-auto mr-auto position-relative">
                    <ul class="side-nav adonis-animate" data-animation="menuTwo" id="site-side-nav" data-level="1" data-animation-item="> li > a">
                        ...
                        <li class="nav-item has-dropdown">
                            <a class="nav-link" href="#" data-level="2">Shop <span class="adonis-icon icon-sm"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="10"><use xlinkHref="#arrow-right" /></svg></span></a>
                            <ul class="sub-level">
                        ...
                        <li class="nav-item has-dropdown">
                            <a class="nav-link" href="#" data-level="2">Browse <span class="adonis-icon icon-sm"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="10"><use xlinkHref="#arrow-right" /></svg></span></a>
                            <ul class="sub-level">
                                <li><a href="#" class="go-back" data-level="1">Back</a></li>
                        ...
                        <li class="nav-item has-dropdown">
                            <a class="nav-link" href="#" data-level="2">Genres <span class="adonis-icon icon-sm"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="10"><use xlinkHref="#arrow-right" /></svg></span></a>
                            <ul class="sub-level">
                                <li><a href="#" class="go-back" data-level="1">Back</a></li>
                        ...
                        <li class="nav-item has-dropdown">
                            <a class="nav-link" href="#" data-level="2">Charts <span class="adonis-highlight-active fs-1">hot</span><span class="adonis-icon icon-sm"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="10"><use xlinkHref="#arrow-right" /></svg></span></a>
                            <ul class="sub-level">
                                <li><a href="#" class="go-back" data-level="1">Back</a></li>
                        ...
                        <li class="nav-item has-dropdown">
                            <a class="nav-link" href="#" data-level="2">More<span class="adonis-icon icon-sm"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="10"><use xlinkHref="#arrow-right" /></svg></span></a>
                            <ul class="sub-level">
                                <li><a href="#" class="go-back" data-level="1">Back</a></li>
