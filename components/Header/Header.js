                        ...
                        <div class="col-2 col-xl-3 d-flex align-items-center">
                            ...
                            <div class="brand">
                                <a class="brand d-flex align-items-center" href="home.html">
                                    ...
                                    <strong class="p-1 fs-6 fs-md-8">HayDayTv</strong> </a>
                            </div>
                        </div>
                            ...
                            <nav class="navbar navbar-expand-lg">
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                            ...
                                            <div class="dropdown-menu dropdown-mega-menu dropdown-bg">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <ul class="list-unstyled mb-3">
                                                        ...
                                                        <li class="menu-item"><a href="featured-playlists.html">Featured Playlists</a></li>
                                                        ...
                                                        <li class="menu-item"><a href="single-artist.html">Single Artist</a></li>
                                                    ...
                                                    <ul class="list-unstyled mb-4">
                                                        ...
                                                        <li class="menu-item"><a href="single-shop-item.html">Single Shop Item</a></li>
                                                    </ul>
                                                </div>
                                                <div class="col">
                                                    <h5>GENRE</h5>
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li class="menu-item"><a href="genre-classical.html">Under Ground</a></li>
                                                        ...
                                                        <li class="menu-item"><a href="genres.html">All genres</a></li>
                                                    </ul>
                                                </div>
                                                <div class="col">
                                                    <h5>CHARTS</h5>
                                                    <ul class="list-unstyled">
                                                        <li class="menu-item"><a href="top-albums.html">Top Albums</a></li>
                                                        <li class="menu-item"><a href="top-artists.html">Top Artists</a></li>
                                                        <li class="menu-item"><a href="weekly-top-ten.html">Weekly Top 15</a></li>
                                                        <li class="menu-item"><a href="usa-top-ten.html">USA Top 10</a></li>
                                                        <li class="menu-item"><a href="hot-songs.html">Hot Songs</a></li>
                                                        <li class="menu-item"><a href="videos.html">Hot Videos</a></li>
                                                    </ul>
                                                </div>
                                        ...
                                        <li class="menu-item">
                                            <a class="nav-link" href="#" data-toggle="dropdown"><span class="adonis-icon icon-4x"><svg xmlns="http://www.w3.org/2000/svg" version="1.1"><use xlinkHref="#icon-horizontal-dots"></use></svg></span></a>
                            ...
                            <div class="nav-item position-relative">
                                <a class="nav-link dropdown-toggle w-nowrap pr-0" href="#" id="dropdownUserSettings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <div class="flex-row d-inline-flex">
                                        <div class="user"><img class="rounded-circle" src="/static/assets/images/user-thumb-1.jpg" alt="" /></div>
