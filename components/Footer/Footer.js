                                            ...
                                            <div class="img-box-horizontal music-img-box img-box-horizontal-style-2">
                                                ...
                                                <div class="hover-state d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <span class="adonis-icon color-active pointer mr-2 icon-2x"><svg xmlns="http://www.w3.org/2000/svg" version="1.1"><use xlinkHref="#icon-heart-blank" /></svg></span>
                                    ...
                                    <div class="widget">
                                        ...
                                        <div class="mobile-apps">
                                            <ul class="list-inline d-inline-flex mb-4">
                                                <li class="mr-2"><img src="/static/assets/images/brand-logo/apple-logo.png" alt="" /></li>
