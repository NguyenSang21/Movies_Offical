...
import CarouselTop_Comedy from '../components/Comedy/CarouselTop_Comedy';

export default class MainComedy extends Component {
    render() {
        return (
            <div id="comedy" class="inactive-hide">
                <CarouselTop_Comedy/>
                <section>
                    <div class="title-box">
                        <h4 class="title h3">Top Songs</h4>
                    </div>
                    <div class="adonis-carousel music-img-box-cont-sm adonis-animate" data-animation="slideUp" data-animation-item=".item" data-auto-width="no" data-loop="no" data-dots="yes" data-items-responsive="0:1|600:2|900:3|1200:4|1500:5">
                        <div class="gutter-30">
                        ...
                        <div class="gutter-30">
                            <div class="owl-carousel owl-theme-adonis">
                                <div class="item">
                                    <div class="music-img-box">
                                        <div class="img-box box-rounded-md">
                                            <img class="retina" src="/static/assets/images/new-releases/new-releases-1.jpg" data-2x="assets/images/new-releases/new-releases-1@2x.jpg" alt="" />
                                ...
                                <div class="item">
                                    <div class="music-img-box">
                                        <div class="img-box box-rounded-md">
                                            <img class="retina" src="/static/assets/images/new-releases/new-releases-2.jpg" data-2x="assets/images/new-releases/new-releases-2@2x.jpg" alt="" />
                                            <div class="hover-state">
                                                <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                    <span class="pointer play-btn-dark round-btn"><i class="play-icon"></i></span>
                                                </div>
                                ...
                                <div class="item">
                                    <div class="music-img-box">
                                        <div class="img-box box-rounded-md">
                                            <img class="retina" src="/static/assets/images/new-releases/new-releases-3.jpg" data-2x="assets/images/new-releases/new-releases-3@2x.jpg" alt="" />
                                            <div class="hover-state">
                                                <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                    <span class="pointer play-btn-dark round-btn"><i class="play-icon"></i></span>
                                                </div>
                                ...
                                <div class="item">
                                    <div class="music-img-box">
                                        <div class="img-box box-rounded-md">
                                            <img class="retina" src="/static/assets/images/new-releases/new-releases-4.jpg" data-2x="assets/images/new-releases/new-releases-4@2x.jpg" alt="" />
                                            <div class="hover-state">
                                                <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                    <span class="pointer play-btn-dark round-btn"><i class="play-icon"></i></span>
                                                </div>
                                ...
                                <div class="item">
                                    <div class="music-img-box">
                                        <div class="img-box box-rounded-md">
                                            <img class="retina" src="/static/assets/images/new-releases/new-releases-5.jpg" data-2x="assets/images/new-releases/new-releases-5@2x.jpg" alt="" />
                                            <div class="hover-state">
                                                <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                    <span class="pointer play-btn-dark round-btn"><i class="play-icon"></i></span>
                                                </div>
                                ...
                                <div class="item">
                                    <div class="music-img-box">
                                        <div class="img-box box-rounded-md">
                                            <img class="retina" src="/static/assets/images/new-releases/new-releases-6.jpg" data-2x="assets/images/new-releases/new-releases-6@2x.jpg" alt="" />
                                            <div class="hover-state">
                                                <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                    <span class="pointer play-btn-dark round-btn"><i class="play-icon"></i></span>
                                                </div>
                                ...
                                <div class="item">
                                    <div class="music-img-box">
                                        <div class="img-box box-rounded-md">
                                            <img class="retina" src="/static/assets/images/new-releases/new-releases-7.jpg" data-2x="assets/images/new-releases/new-releases-7@2x.jpg" alt="" />
                                            <div class="hover-state">
                                                <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                    <span class="pointer play-btn-dark round-btn"><i class="play-icon"></i></span>
                                                </div>
                                ...
                                <div class="item">
                                    <div class="music-img-box">
                                        <div class="img-box box-rounded-md">
                                            <img class="retina" src="/static/assets/images/new-releases/new-releases-8.jpg" data-2x="assets/images/new-releases/new-releases-8@2x.jpg" alt="" />
                                            <div class="hover-state">
                                                <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                    <span class="pointer play-btn-dark round-btn"><i class="play-icon"></i></span>
                                                </div>
                                ...
                                <div class="item">
                                    <div class="music-img-box">
                                        <div class="img-box box-rounded-md">
                                            <img class="retina" src="/static/assets/images/new-releases/new-releases-9.jpg" data-2x="assets/images/new-releases/new-releases-9@2x.jpg" alt="" />
                                            <div class="hover-state">
                                                <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                    <span class="pointer play-btn-dark round-btn"><i class="play-icon"></i></span>
                                                </div>
                ...
                <section>
                    ...
                    <div class="adonis-carousel viewport-animate" data-animation="slideUp" data-animation-item=".item" data-dots="yes" data-items="7" data-items-responsive="0:1|600:2|900:3|1200:4|1600:5">
                        <div class="gutter-30">
                            <div class="owl-carousel owl-theme-adonis">
                                <div class="item">
                                    <div class="music-img-box">
                                        <div class="img-box box-rounded-md">
                                            <img class="retina" src="/static/assets/images/videos/videos-1.jpg" data-2x="assets/images/videos/videos-1@2x.jpg" alt="" />
                                            <div class="hover-state">
                                                <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                    <span class="pointer play-btn-dark round-btn"><i class="play-icon"></i></span>
                                                </div>
                                ...
                                <div class="item">
                                    <div class="music-img-box">
                                        <div class="img-box box-rounded-md">
                                            <img class="retina" src="/static/assets/images/videos/videos-2.jpg" data-2x="assets/images/videos/videos-2@2x.jpg" alt="" />
                                            <div class="hover-state">
                                                <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                    <span class="pointer play-btn-dark round-btn"><i class="play-icon"></i></span>
                                                </div>
                                ...
                                <div class="item">
                                    <div class="music-img-box">
                                        <div class="img-box box-rounded-md">
                                            <img class="retina" src="/static/assets/images/videos/videos-3.jpg" data-2x="assets/images/videos/videos-3@2x.jpg" alt="" />
                                            <div class="hover-state">
                                                <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                    <span class="pointer play-btn-dark round-btn"><i class="play-icon"></i></span>
                                                </div>
                                ...
                                <div class="item">
                                    <div class="music-img-box">
                                        <div class="img-box box-rounded-md">
                                            <img class="retina" src="/static/assets/images/videos/videos-4.jpg" data-2x="assets/images/videos/videos-4@2x.jpg" alt="" />
                                            <div class="hover-state">
                                                <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                    <span class="pointer play-btn-dark round-btn"><i class="play-icon"></i></span>
                                                </div>
                                ...
                                <div class="item">
                                    <div class="music-img-box">
                                        <div class="img-box box-rounded-md">
                                            <img class="retina" src="/static/assets/images/videos/videos-5.jpg" data-2x="assets/images/videos/videos-5@2x.jpg" alt="" />
                                            <div class="hover-state">
                                                <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                    <span class="pointer play-btn-dark round-btn"><i class="play-icon"></i></span>
                                                </div>
                                ...
                                <div class="item">
                                    <div class="music-img-box">
                                        <div class="img-box box-rounded-md">
                                            <img class="retina" src="/static/assets/images/videos/videos-6.jpg" data-2x="assets/images/videos/videos-6@2x.jpg" alt="" />
                                            <div class="hover-state">
                                                <div class="absolute-bottom-left pl-e-20 pb-e-20">
                                                    <span class="pointer play-btn-dark round-btn"><i class="play-icon"></i></span>
                                                </div>
                ...
                <section>
                    ...
                    <div class="adonis-carousel viewport-animate auto-fit-columns" data-auto-fit-items=".item" data-item-parent=".owl-carousel" data-item-width="180" data-item-max-width="360" data-animation="slideUp" data-animation-item=".item" data-dots="yes" data-auto-width="yes">
                        <div class="gutter-30">
                            <div class="owl-carousel owl-theme-adonis">
                                <div class="item">
                                    <div class="music-img-box">
